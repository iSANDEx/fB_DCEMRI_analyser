...
-   **Anatomy and survey scans:** Localisers and anatomical scans, not
...
-   **Intra-scan**: Registration is performed on the DCE-MRI scans of
...
## Draft Mockup Graphical User Interface (GUI) {#mockupGUI}
